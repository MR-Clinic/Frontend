...
function Check() {
  ...
  const complaint =
    typeof window !== "undefined" ? localStorage.getItem("complaint") : null;
  ...
  const visitUid =
    typeof window !== "undefined" ? localStorage.getItem("vuid") : null;
  ...
  useEffect(() => {
    ...
    if (pasienUid) {
      ...
      dispatch(allStore.getPatientModal(pasienUid)).then((e) => {
        NIKSet(e.nik);
        NamaSet(e.name);
        JenisSet(e.gender);
        AlamatSet(e.address);
  ...
  return (
    <>
      <Head>
        <title>Doctor Page - Checkup</title>
        <meta property="og:title" content="Doctor Page - Checkup" key="title" />
      </Head>
      <Nav />
      <Sidebar />
        ...
        <div className="ml-[7%] mr-[calc(9%-70px)]">
          <div className="px-5 flex justify-between border-b-2 border-gray-600 ">
            <div className="flex flex-col justify-start">
              <p className="text-3xl font-bold pt-10">{Nama}</p>
              <p className="font-light text-xl leading-tight mb-2 ">{NIK}</p>
            </div>
            <div className="font-bold text-right text-3xl pt-10">
              No. Medical Records.
              <p className="font-light text-xl leading-tight mb-2 ">{noMR}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 justify-items-stretch gap-10">
                ...
                <div className="flex flex-wrap justify-between">
                  <div className="text-medium font-semibold px-3">
                    ...
                    <input
                      ...
                      type="text"
                      onChange={(e) => {
                        bloodPressuseSet(e.target.value);
                      }}
                    />
                  </div>
                  <div className="text-medium font-semibold px-3">
                  ...
                  <div className="text-medium font-semibold px-3">
                    ...
                    <input
                      ...
                      type="text"
                      onChange={(e) => {
                        respiratoryRateSet(e.target.value);
                      }}
                    />
                  </div>
                  <div className="text-medium font-semibold px-3">
              ...
              <div>
                ...
                <div className="px-3">
                  ...
                  <textarea
                    ...
                    type="text"
                    onChange={(e) => {
                      mainDiagnoseSet(e.target.value);
                    }}
                  />
                  ...
                  <textarea
                    ...
                    type="text"
                    onChange={(e) => {
                      addiditonDiagnoseSet(e.target.value);
                    }}
                  />
                  <p> Tindakan </p>
                  <textarea
              ...
              <div>
                ...
                <div className="px-2">
                        ...
                        >
                          <Menu.Items className="absolute origin-top-right  mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 max-h-[200px] w-full overflow-y-scroll focus:outline-none">
                            <Menu.Item>
                              ...
                              >
                                <span className="w-full ">Hari</span>
                              </div>
                            </Menu.Item>
                            <Menu.Item>
                              <div
                  ...
                  <button
                    className=" font-semibold items-center text-white px-3 py-1 border-2 bg-[#324B50] rounded-lg hover:opacity-80 "
                    onClick={() => {
                      addObatList();
                    }}
                  >
                  ...
                  <div className="flex justify-end items-end mt-5  ">
                    <span
                      className="text-white font-semibold px-6 py-2 bg-[#324B50] rounded-lg hover:opacity-80 cursor-pointer flex justify-center items-center"
